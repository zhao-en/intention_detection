...
def train_lstm(model, x_train, y_train, x_test, y_test):
    ...
    # f =  open('D:/PyCharm 2019.2/projects/lstm_softmax/output/word2vec_lstm_softmax_history', 'w')
    ...
    with open('output/word2vec_lstm_softmax.yml', 'w') as outfile:
        outfile.write(yaml.dump(yaml_string, default_flow_style=True))
    model.save('output/word2vec_lstm_softmax.h5')
...
def test():
    ...
    # 五个意图统计
    result = []
    lstm_model = load_model('D:\\PyCharm 2019.2\\projects\\lstm_softmax\\output\\word2vec_lstm_softmax.h5')
    for path in paths:
...
if __name__ == '__main__':
    ...
    # inp = input_transform("找一家有中国菜品的餐厅啊") #1
    #
    # model_save_path = 'D:\\PyCharm 2019.2\\projects\\lstm_softmax\\output\\word2vec_lstm_softmax.h5'
