...
# 1170/1170 [==============================] - 7s 6ms/step - loss: 0.1652 - acc: 0.9402 - val_loss: 1.0788 - val_acc: 0.7679
...
def train_lstm(model, x_train, y_train, x_test, y_test):
    ...
    f = open('D:/PyCharm 2019.2/projects/lstm_softmax/output/word2vec_bilstm_softmax_history', 'w')
    ...
    with open('output/word2vec_bilstm_softmax.yml', 'w') as outfile:
        outfile.write(yaml.dump(yaml_string, default_flow_style=True))
    model.save('output/word2vec_bilstm_softmax.h5')
...
def test():
    ...
    # 五个意图统计
    result = []
    lstm_model = load_model('D:\\PyCharm 2019.2\\projects\\lstm_softmax\\output\\word2vec_bilstm_softmax.h5')
    for path in paths:
